...
extern void dbg_printDec(uint16_t number);
extern void dbg_printStr(char* msg);

#else
  #define dbg_tx_init()		
  #define dbg_putchar(A)		((void)(A))
  #define dbg_printDec(A)		((void)(A))
  #define dbg_printStr(A)		((void)(A))
#warning UART DEBUG IS DISABLED
